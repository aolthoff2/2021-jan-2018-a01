    ...
    <div class="row">
        <div class="offset-2">
            <blockquote class="alert alert-info">
                THIS PAGE WILL USE THE ASP: LISTVIEW CONTROL
                <br />
                ...
                THIS PAGE WILL DEMONSTRATE VALIDATION ON THE ASP:LISTVIEW CONTROL
            </blockquote>
        </div>
    </div>
    <div class="row">
            ...
            <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" InsertItemPosition="LastItem"
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color: #FFFFFF; color: #284775;">
                        ...
                        <td>
                            <asp:Label Text='<%# Eval("AlbumId") %>' runat="server" ID="AlbumIdLabel" Width="70px" Enabled="false" /></td>
                        <td>
                ...
                <EditItemTemplate>
                    <%-- Validation control will be placed inside the associated Template
                    ...
                    <asp:RequiredFieldValidator ID="RequiredTitleE" runat="server" ErrorMessage="Album Title is required on EDIT."
                        ControlToValidate="TitleTextBoxE" Display="None" ValidationGroup="egroup"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredReleaseYearE" runat="server" ErrorMessage="Release Year is required on EDIT."
                        ControlToValidate="ReleaseYearTextBoxE" Display="None" ValidationGroup="egroup"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExTitleE" runat="server" ErrorMessage="Album Title is limited to 160 characters."
                        ControlToValidate="TitleTextboxE" Display="None"
                        ValidationGroup="egroup" ValidationExpression="^.{1,160}$"></asp:RegularExpressionValidator>
                    <asp:RegularExpressionValidator ID="RegularExReleaseLabelE" runat="server" ErrorMessage="Release Label is limited to 50 characters."
                        ControlToValidate="ReleaseLabelTextboxE" Display="None"
                        ValidationGroup="egroup" ValidationExpression="^.{1,50}$"></asp:RegularExpressionValidator>
                    ...
                    <asp:RangeValidator ID="RangeReleaseYearE" runat="server" ErrorMessage="Year must be between 1950 and the current year" ControlToValidate="ReleaseYearTextBoxE"
                        Display="None" ValidationGroup="egroup" MinimumValue="1950" MaximumValue="<%# DateTime.Today.Year %>"></asp:RangeValidator>
                    <tr style="background-color: #999999;">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server"
                                ID="ReleaseYearTextBoxE" /></td>
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseLabel") %>' runat="server"
                                ID="ReleaseLabelTextBoxE" Width="70px" /></td>
                    </tr>
                </EditItemTemplate>
                <EmptyDataTemplate>
                ...
                <InsertItemTemplate>
                    <asp:RequiredFieldValidator ID="RequiredTitleI" runat="server" ErrorMessage="Album Title is required on INSERT."
                        ControlToValidate="TitleTextBoxI" Display="None" ValidationGroup="igroup"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredReleaseYearI" runat="server" ErrorMessage="Release Year is required on INSERT."
                        ControlToValidate="ReleaseYearTextBoxI" Display="None" ValidationGroup="igroup"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExReleaseLabelI" runat="server" ErrorMessage="Release Label is limited to 50 characters."
                        ControlToValidate="ReleaseLabelTextboxI" Display="None"
                        ValidationGroup="igroup" ValidationExpression="^.{1,50}$"></asp:RegularExpressionValidator>
                    <asp:CompareValidator ID="CompareReleaseYearI" runat="server" ErrorMessage="Year must be a number."
                        ControlToValidate="ReleaseYearTextBoxI" Display="None" Operator="DataTypeCheck" Type="Integer" ValidationGroup="igroup"></asp:CompareValidator>
                    <asp:RangeValidator ID="RangeReleaseYearI" runat="server" ErrorMessage="Year must be between 1950 and the current year." ControlToValidate="ReleaseYearTextBoxI"
                        Display="None" ValidationGroup="igroup" MinimumValue="1950" MaximumValue="<%# DateTime.Today.Year %>"></asp:RangeValidator>
                    <tr style="">
                        <td>
